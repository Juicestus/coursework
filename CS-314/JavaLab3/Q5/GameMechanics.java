...
public class GameMechanics {
    ...
    public static int advancedWinChancesComparator(
        Character c1, Character c2
    ) {
        double hearts1, hearts2;
        if ((c1 instanceof Hero) && (c2 instanceof Villain)) {
        ...
        return hearts1 > hearts2 ? -1 : 1;
    }

    public static void sortedBattlefieldCharacters(
        ArrayList<Character> characters
    ) {
        // characters.sort((Character c1, Character c2) -> {
        //     return advancedWinChancesComparator(c1, c2);
        // });
        characters.sort(GameMechanics::advancedWinChancesComparator);
    }
