...
In this activity, you will use a simple program, which is known as
script.py, to see if you understand how simple
...
(./script.py) or possibly this (python
script.py). When you run it with the -h (help) flag, you 
see:
